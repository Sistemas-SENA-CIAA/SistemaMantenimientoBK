...
class EquiposController {
    ...
    listarEquipos(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield equipoModel_1.Equipo.find({ relations: ['cuentaDante', 'tipoEquipo', 'estado', 'subsede', 'equipo.mantenimientos', 'mantenimientos', 'dependencia', 'ambiente', 'equipo.ambiente', 'chequeos'] });
